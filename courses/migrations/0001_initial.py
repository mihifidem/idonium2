    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='courses_images/default.jpg', null=True, upload_to='courses_images/')),
                ...
                ('hardskills', models.ManyToManyField(blank=True, to='profile_cv.hardskill')),
            ],
        ),
        migrations.CreateModel(
            name='Certificate',
            fields=[
                ...
                ('ext_certificate', models.FileField(blank=True, null=True, upload_to='certificates/')),
                ('user', models.ManyToManyField(blank=True, related_name='certificates', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_free', models.BooleanField(default=False)),
                ('price', models.DecimalField(blank=True, decimal_places=2, default=Decimal('0.00'), max_digits=10, null=True)),
                ('hardskill', models.ManyToManyField(blank=True, related_name='hardskills', to='profile_cv.hardskill')),
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.CheckConstraint(condition=models.Q(models.Q(('course__isnull', False), ('resource__isnull', True)), models.Q(('course__isnull', True), ('resource__isnull', False)), _connector='OR'), name='review_course_or_resource_not_both'), models.UniqueConstraint(fields=('user', 'course'), name='unique_user_course_review'), models.UniqueConstraint(fields=('user', 'resource'), name='unique_user_resource_review')],
            },
        ),
