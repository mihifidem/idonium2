...
<<<<<<< HEAD
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        default="courses_images/default.jpg",
                        null=True,
...
<<<<<<< HEAD
                ...
                (
                    "hardskill",
                    models.ManyToManyField(
                        blank=True, related_name="hardskills", to="profile_cv.hardskill"
                    ),
                ),
                (
                    "lesson",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="users_completed_lessons",
                        to="courses.lesson",
                    ),
                ),
            ],
            ...
            options={
                "constraints": [
                    models.CheckConstraint(
                        condition=models.Q(
                            models.Q(
                                ("course__isnull", False), ("resource__isnull", True)
                            ),
                            models.Q(
                                ("course__isnull", True), ("resource__isnull", False)
                            ),
                            _connector="OR",
                        ),
                    ...
                    models.UniqueConstraint(
                        fields=("user", "resource"), name="unique_user_resource_review"
                    ),
                ],
            },
        ),
