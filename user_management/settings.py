...
SUMMERNOTE_CONFIG = {
    ...
    'height': '480',  # Ajusta la altura del editor
    'toolbar': [
...
=======
    "test_management"
>>>>>>> 9386cd89b8d0b1ef0a3b59557215d7901a5ffa2c
]
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / "static"]  # Opcional, si tienes una carpeta "static" en tu proyecto
