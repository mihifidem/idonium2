# Generated by Django 3.2.12 on 2024-11-27 09:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('headhunter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='headhunters.headhunter')),
            ],
        ),
        migrations.CreateModel(
            name='StatusAction',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('candidate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='headhunters.candidateprofile')),
                ('headhunter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='headhunters.headhunter')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='status',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='headhunters.statuscandidate'),
        ),
        migrations.CreateModel(
            name='Action',
            fields=[
