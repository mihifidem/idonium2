...
urlpatterns = [
    ...
    path('academic_educations/<int:profile_id>', academic_education_list, name='academic_education_list'),
    path('academic_educations/create/<int:profile_id>', academic_education_create, name='academic_education_create'),
    ...
    # Soft skill URLs
    path('soft_skills/<int:profile_id>', softskill_list, name='soft_skill_list'),
    path('soft_skills/create/<int:profile_id>', softskill_create, name='soft_skill_create'),
    ...
    # Language URLs
    path('languages/<int:profile_id>', language_list, name='language_list'),
    path('languages/create/<int:profile_id>', language_create, name='language_create'),
    ...
    # Volunteering URLs
    path('volunteerings/<int:profile_id>', volunteering_list, name='volunteering_list'),
    path('volunteerings/create/<int:profile_id>', volunteering_create, name='volunteering_create'),
