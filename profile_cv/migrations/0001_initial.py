# Generated by Django 3.2.12 on 2024-11-27 09:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('academic_educations', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='profile_cv.academiceducation')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='profile_cv.categoryuser')),
                ('certifications_courses', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='profile_cv.certificationcourse')),
                ('hard_skills', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='profile_cv.hardskilluser')),
                ('incorporation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='profile_cv.incorporationuser')),
                ('languages', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='profile_cv.languageuser')),
            ],
        ),
        migrations.CreateModel(
            name='Project',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_cv', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='profile_cv.profile_cv')),
            ],
        ),
        migrations.CreateModel(
            name='SoftSkillUser',
        ...
        migrations.AddField(
            ...
            name='projects',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='profile_cv.project'),
        ),
        migrations.AddField(
            model_name='profile_cv',
            name='publications',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='profile_cv.publication'),
        ),
        migrations.AddField(
            model_name='profile_cv',
            name='recognitions_awards',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='profile_cv.recognitionaward'),
        ),
        migrations.AddField(
            model_name='profile_cv',
            name='sector',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='profile_cv.sectoruser'),
        ),
        migrations.AddField(
            model_name='profile_cv',
            name='soft_skills',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='profile_cv.softskilluser'),
        ),
        migrations.AddField(
            model_name='profile_cv',
            name='user',
        ...
        migrations.AddField(
            model_name='profile_cv',
            name='volunteerings',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='profile_cv.volunteering'),
        ),
        migrations.AddField(
            model_name='profile_cv',
            name='work_experiences',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='profile_cv.workexperience'),
        ),
    ]
