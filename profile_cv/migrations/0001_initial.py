...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='category',
            name='sector',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='profile_cv.sector'),
        ),
        migrations.CreateModel(
            name='SectorUser',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='profile_cv.template')),
            ],
        ),
        migrations.CreateModel(
            name='UserCvRelation',
