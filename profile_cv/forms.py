...
class UserCvForm(forms.ModelForm):
    class Meta:
        ...
        labels = {
            'has_img_profile': 'Show Profile Picture',
            'has_address': 'Show Address',
            'has_phone_1': 'Show Primary Phone Number',
            'has_phone_2': 'Show Secondary Phone Number',
            'has_email_1': 'Show Primary Email',
            'has_email_2': 'Show Secondary Email',
            'has_dni': 'Show Dni',
            'has_url': 'Show Website',
            'has_biography': 'Show Biography',
            'has_open_to_work': 'Show Open to Work',
            'has_vehicle': 'Show Vehicle',
            'has_disability': 'Show Disability',
            'has_disability_percentage': 'Show Disability Percentage',
            'has_incorporation': 'Show Incorporation',
            'has_sector': 'Show Sector',
            'has_category': 'Show Category',
            'has_work_experiences': 'Show Work Experiences',
            'has_hard_skills': 'Show Hard Skills',
            'has_soft_skills': 'Show Soft Skills',
            'has_languages': 'Show Languages',
            'has_academic_educations': 'Show Academic Educations',
            'has_volunteerings': 'Show Volunteerings',
            'has_projects': 'Show Projects',
            'has_publications': 'Show Publications',
            'has_recognitions_awards': 'Show Recognitions and Awards',            
            'has_certifications_courses': 'Show Certifications and Courses',    
